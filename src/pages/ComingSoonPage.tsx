  ...
  return (
    <div className="min-h-screen bg-[#437874] flex items-center justify-center">
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold text-white mb-4" style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
          Coming Soon
        </h1>
        
        <p className="text-xl text-white/80 mb-8 max-w-md mx-auto" style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
